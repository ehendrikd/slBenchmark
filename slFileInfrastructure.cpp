...
slFileInfrastructure::slFileInfrastructure(string dirname, slInfrastructureSetup newInfrastructureSetup) : slInfrastructure(string("slFileInfrastructure"), newInfrastructureSetup) {
